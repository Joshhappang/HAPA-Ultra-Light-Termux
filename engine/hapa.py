...
ledger_path = "/data/data/com.termux/files/home/HAPA/ledger/ledger_1771248768/ledger_sample"
backup_path = "/data/data/com.termux/files/home/HAPA_BACKUP"

# ----- Backup ledger sebelum mining/staking -----
shutil.copytree(ledger_path, f"{backup_path}/ledger_backup_{int(time.time())}", dirs_exist_ok=True)
print(f"💾 Ledger dicadangkan ke {backup_path}")
...
# ----- MAIN LOOP -----
try:
    print("🔄 HAPA Ultra-Light Termux + Gradual Rollout Publik 0.5 HAPA + Backup Otomatis")
